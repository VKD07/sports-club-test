...
const mainClass = computed(() => {
  if (props.condensed) {
    return 'bg-muted-50 dark:bg-muted-900 relative min-h-screen w-full overflow-x-hidden overflow-x-visible'
  }

  if (!collapseEnabled.value) {
    return 'bg-muted-50 dark:bg-muted-900 relative min-h-screen w-full overflow-x-hidden overflow-x-visible px-4 transition-all duration-300 xl:px-10'
  }

  const list = [
    'bg-muted-50 dark:bg-muted-900 relative min-h-screen w-full overflow-x-hidden overflow-x-visible px-4 transition-all duration-300 xl:px-10',
  ]
...
<template>
  <div class="bg-muted-50 dark:bg-muted-900 pb-20">
