...
<template>
  <BaseCard
    class="dark:bg-muted-900 pointer-events-auto relative z-[999999] flex border bg-white shadow-md"
  ...
  >
    ...
    <div class="text-md min-w-[220px] max-w-xl py-4 pe-12 ps-8">
      <strong v-if="props.title" class="text-semibold font-heading maw-w-lg block truncate">
        {{ props.title }}
      </strong>
      <p v-if="props.message" class="text-muted-600 dark:text-muted-400 whitespace-pre-wrap">
        {{ props.message }}
      </p>
    </div>
  </BaseCard>
