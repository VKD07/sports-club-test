...
watch([filter, schoolFilter, dateStart, dateEnd, department, status, perPage], () => {
  router.push({
    query: {
      page: undefined,
    },
    ...
    <TairoContentWrapper>
      <div class="flex gap-4 lg:items-center justify-between p-4 my-2 flex-col lg:flex-row">
        <div>
          ...
          >
            School Users Support Enquiries
          </BaseHeading>

          <BaseText size="sm" class="text-muted-600 dark:text-muted-400">
            Monitor and manage all support inquiries from school staff.
          </BaseText>
        </div>
      ...
      <div class="relative">
        <BaseCard class="ptablet:py-8 ptablet:px-2 mb-10 py-4 px-4">
          ...
          >
            ...
            <div class="ptablet:col-span-6 w-full px-2 py-2 sm:w-2/4 relative">
              <BaseButtonClose
              ...
              >
                ...
                <template #end>
                  ...
                  <FlexTableCell label="action" :hide-label="index > 0">
                    ...
                    >
                      <BaseDropdownItem
                        :to="`/support-ticket/${ticket.id}?tab=Schools`"
                        title="Manage"
                        text="Manage ticket"
                        shape="smooth"
                      />
