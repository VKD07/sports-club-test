      ...
      <MenuButton as="template">
        ...
        >
          <div class="relative inline-flex h-10 w-10 items-center justify-center rounded-full">
            <img src="/img/avatars/3.svg" class="max-w-full rounded-full object-cover shadow-sm dark:border-transparent" alt="" />
          </div>
        </button>
      </MenuButton>
        ...
        >
          <div class="bg-muted-50 dark:bg-muted-700/40 p-6">
            <div class="flex items-center">
              ...
              <div class="ms-3">
                <h6 class="font-heading text-muted-800 text-sm font-medium dark:text-white">User ID</h6>
                <p class="text-muted-400 font-sans text-xs">Firstname</p>
              </div>
            </div>
          </div>
          <div class="p-2">
            <MenuItem as="div" v-slot="{ active }">
              <NuxtLink
                ...
                :class="[active ? 'bg-muted-100 dark:bg-muted-700 text-primary-500' : 'text-muted-400']"
                @click.passive="close"
              >
                <Icon name="ph:user-circle-duotone" class="h-5 w-5" />
                <div class="ms-3">
                  <h6 class="font-heading text-muted-800 text-xs font-medium leading-none dark:text-white">Profile</h6>
            ...
            <MenuItem as="div" v-slot="{ active }">
              ...
              >
                ...
                <div class="ms-3">
                  <h6 class="font-heading text-muted-800 text-xs font-medium leading-none dark:text-white">Settings</h6>
                  <p class="text-muted-400 font-sans text-xs">Account settings</p>
                </div>
              </NuxtLink>
            </MenuItem>
            <div class="my-3">
              <BaseButton @click.passive="close" shape="curved" class="w-full"> Logout </BaseButton>
            </div>
          </div>
        </MenuItems>
      </Transition>
