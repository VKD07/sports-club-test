  ...
  <div class="group inline-flex items-center justify-center text-right">
    <Menu as="div" class="relative h-9 text-left" v-slot="{ close }">
      <MenuButton as="div">
        ...
        >
          <span
            class="border-muted-200 dark:border-muted-700 dark:bg-muted-800 group-hover:ring-muted-200 dark:group-hover:ring-muted-700 dark:ring-offset-muted-900 flex h-9 w-9 items-center justify-center border bg-white rounded-full ring-1 ring-transparent transition-all duration-300 group-hover:ring-offset-4"
          >
            <Icon name="ph:bell-duotone" class="text-muted-400 h-5 w-5" />
          </span>
          <span class="mx-2 text-sm hidden lg:block">Notifications</span>
        </button>
      </MenuButton>
