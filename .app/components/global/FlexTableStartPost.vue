...
<template>
  ...
  >
    <span
      ...
      @click="emits('sort-column', props.label)"
    >
      {{ props.label }}
      <Icon
        v-if="props.sort"
        name="mdi:sort"
        class="text-primary-500 dark:text-muted-500 block size-8 mt-[-2px]"
      />
    </span>
    <BaseAvatar
      v-if="
    ...
    <div>
      ...
      <div class="flex items-center justify-between sm:justify-start">
        ...
        >
          <Icon name="material-symbols:account-circle-full" class="h-3 w-3" />
