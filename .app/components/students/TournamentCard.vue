  ...
  <BaseCard shape="curved" class="p-4 shadow-md pb-16">
    ...
    <div class="flex gap-4 items-center justify-between mt-4">
      <div class="flex gap-2 flex-wrap">
        <BaseParagraph size="xs" class="text-muted-500"> Completion rate </BaseParagraph>
        <BaseHeading tag="h3" size="md" weight="bold" lead="none" class="text-primary-500 dark:text-white">
    ...
    >
      <h4 class="text-primary-500 dark:text-muted-100 font-sans text-xs font-medium">Leaderboard position</h4>

      <div class="text-base px-2 rounded-full w-8 h-8 flex items-center justify-center bg-primary-50 dark:bg-muted-600">
        {{ tournament.position }}
      </div>
    </div>
  </BaseCard>
