    ...
    <form method="POST" action="" class="w-full pb-16" @submit.prevent="onSubmit">
      ...
      <BaseCard class="mt-6">
        <div class="max-w-3xl p-8">
          <TairoFormGroup label="Tournament details" sublabel="Others diserve to know you more">
            <div class="grid grid-cols-12 gap-6">
              ...
              <div class="col-span-12 sm:col-span-6">
                <label class="nui-label pb-2 text-[0.825rem] w-full">Tournament main banner</label>
                <BaseParagraph
                  size="xs"
                  lead="tight"
              ...
              <div class="col-span-12 sm:col-span-6">
                <label class="nui-label pb-2 text-[0.825rem] w-full">Eligible school</label>
              ...
              <div class="col-span-12 sm:col-span-6">
                <label class="nui-label pb-2 text-[0.825rem] w-full">Eligible criteria</label>
                <div class="grid grid-cols-2 gap-6 mt-1">
                  <BaseRadio
                    label="All students"
              ...
              <div class="col-span-12 sm:col-span-6">
                <BaseListbox label="Term" :items="term" placeholder="Select term" />
              </div>
              <div class="col-span-12 sm:col-span-6">
                <BaseInput
      ...
      <BaseCard class="mt-6">
        <div class="max-w-3xl p-8">
          <TairoFormGroup
            label="Introduction for the game"
            sublabel="Others diserve to know you more"
          >
            <div class="grid grid-cols-12 gap-6">
              <div class="col-span-12 sm:col-span-6">
                <BaseAutocomplete label="Game" :items="games" placeholder="Search game" />
              </div>
              <div class="col-span-12 sm:col-span-6">
                <BaseListbox label="Age appropriate" :items="age" placeholder="Select age" />
              </div>
              <div class="col-span-12 sm:col-span-12">
                <BaseTextarea
              ...
              <div class="col-span-12 sm:col-span-6">
                <label class="nui-label pb-2 text-[0.825rem] w-full">Section score</label>
                <BaseButtonGroup>
                  <BaseInput
                    type="text"
      ...
      <BaseCard class="mt-6">
        <div class="max-w-3xl p-8">
          <TairoFormGroup label="Skills and learning" sublabel="Others diserve to know you more">
            <div class="grid grid-cols-12 gap-6">
              <div class="col-span-12 sm:col-span-12">
                <BaseTextarea label="Section description" placeholder="Write some description..." />
              </div>
              <div class="col-span-12 sm:col-span-12">
                <label class="nui-label pb-2 text-[0.825rem] w-full">List of skills</label>
      ...
      <BaseCard class="mt-6">
        <div class="max-w-3xl p-8">
          <TairoFormGroup label="Scoring and direction" sublabel="Others diserve to know you more">
            <div class="grid grid-cols-12 gap-6">
              <div class="col-span-12 sm:col-span-12">
                <BaseTextarea label="Section description" placeholder="Write some description..." />
              </div>
              ...
              <div class="col-span-12 sm:col-span-12">
                <label class="nui-label pb-2 text-[0.825rem] w-full">Score table</label>
                <div class="grid grid-cols-12 sm:gap-4">
              ...
              <div class="col-span-12 sm:col-span-12">
                <BaseTextarea label="Awards" placeholder="Write some description..." />
              </div>
              <div class="col-span-12 sm:col-span-12">
      ...
      <BaseCard class="mt-6">
        <div class="max-w-3xl p-8">
          <TairoFormGroup
            label="Gaming devices and downloads"
            sublabel="Others diserve to know you more"
          >
            <div class="grid grid-cols-12 gap-6">
              <div class="col-span-12 sm:col-span-12">
      ...
      <BaseCard class="mt-6">
        <div class="max-w-3xl p-8">
          <TairoFormGroup label="Final task" sublabel="Others diserve to know you more">
            <div class="grid grid-cols-12 gap-6">
              <div class="col-span-12 sm:col-span-12">
                <BaseTextarea label="Section description" placeholder="Write some description..." />
              </div>
