...
definePageMeta({
  title: 'Add Task (Coaching)',
  path: '/tasks/add-coaching',
  middleware: ['auth'],
})
...
const taskCategory = ref(['Coaching'])
...
const removeConsoles = (index: number) => {
  if (values.coaching_video?.consoles) {
    const updatedConsoles = [...values.coaching_video?.consoles]
    updatedConsoles.splice(index, 1)
    gamingConsoles.value = updatedConsoles
    setFieldValue('coaching_video.consoles', gamingConsoles.value)
  }
}
...
<template>
  <div>
    ...
    <form method="POST" action="" class="w-full pb-16" @submit.prevent="onSubmit">
            ...
            <div class="grid grid-cols-12 gap-6">
              ...
              <div class="col-span-12 sm:col-span-6">
                ...
                <div v-if="!values.introduction_game?.image">
                  <BaseButton color="primary" @click="addBanner('introduction_game.image')">
                    <Icon name="icon-park-outline:upload-picture" class="me-1 size-4" />
                  ...
                  >
                    <div class="flex items-center gap-2">
                      <div class="shrink-0">
                        <img
                          class="size-14 rounded-md object-cover object-center w-16"
                          :src="values.introduction_game?.image"
                          alt="Image preview"
                        />
                      </div>
      ...
      <BaseCard class="mt-6">
        <div class="max-w-3xl p-8 py-12">
          <TairoFormGroup label="Coaching video">
            <div class="grid grid-cols-12 gap-6">
              <div class="col-span-12 sm:col-span-12">
                <Field
                  v-slot="{ field, errorMessage, handleChange, handleBlur }"
                  name="coaching_video.description"
                >
                  <CustomQuillEditor
                    fieldName="coaching_video.description"
                    label="Section description"
                    placeholder="Write some description..."
                    :content="field.value"
                    @update:model-value="handleChange"
              ...
              <div class="col-span-12 sm:col-span-6">
                <Field
                  v-slot="{ field, errorMessage, handleChange, handleBlur }"
                  name="coaching_video.video_title"
                >
                  <BaseInput
                    :model-value="field.value"
                    :error="errorMessage"
                ...
                <div v-for="(game, index) in gamingConsoles" :key="index">
                  <div class="grid grid-cols-12 mb-3 sm:gap-4">
                    <div class="col-span-12 sm:col-span-4">
                      <Field
                        v-slot="{ field, errorMessage, handleChange, handleBlur }"
                        :name="`coaching_video.consoles[${index}].console`"
                      >
                        <BaseListbox
                          :items="consoles"
                    ...
                    <div class="col-span-12 sm:col-span-7">
                      <Field
                        v-slot="{ field, errorMessage, handleChange, handleBlur }"
                        :name="`coaching_video.consoles[${index}].url`"
                      >
                        <BaseInput
                          :model-value="field.value"
                          :error="errorMessage"
              ...
              <div class="col-span-12 sm:col-span-6">
                ...
                <div v-if="!values.coaching_video?.image">
                  <BaseButton color="primary" @click="addBanner('coaching_video.image')">
                    <Icon name="icon-park-outline:upload-picture" class="me-1 size-4" />
                    <span>Add Section Image</span>
                  </BaseButton>
                </div>
                  ...
                  >
                    <div class="flex items-center gap-2">
                      <div class="shrink-0">
                        <img
                          class="size-14 rounded-md object-cover object-center w-16"
                          :src="values.coaching_video?.image"
                          alt="Image preview"
                        />
                      </div>
                    ...
                    <div class="flex gap-2">
                      <button
                        ...
                        type="button"
                        tooltip="Remove"
                        @click.prevent="removeBanner('coaching_video.image')"
                      >
                        <Icon name="lucide:x" class="size-4" />
                        <span class="sr-only">Remove</span>
                      </button>
