...
const activePosts = ref('all-gaming')
</script>
...
<template>
  ...
  <div class="rounded-3xl relative">
    ...
    >
      ...
      <div class="">
        <div
          class="grid grid-cols-2 w-fit divide-x bg-primary-500 rounded-lg px-8 py-2"
        >
  ...
  <div class="mt-12">
    <div class="mb-6">
      <div class="flex gap-2 sm:justify-center">
        <BaseButtonAction
          :color="activePosts === 'all-gaming' ? 'primary' : 'default'"
          @click="activePosts = 'all-gaming'"
          class="tab-button"
        >
          All Gaming
        </BaseButtonAction>
        <BaseButtonAction
          :color="activePosts === 'core-skills' ? 'primary' : 'default'"
          @click="activePosts = 'core-skills'"
          class="tab-button"
        >
          Core Skills Development
        </BaseButtonAction>
        <BaseButtonAction
          :color="activePosts === 'creative-series' ? 'primary' : 'default'"
          @click="activePosts = 'creative-series'"
          class="tab-button"
        >
          Creative Series
        </BaseButtonAction>
        <BaseButtonAction
          :color="activePosts === 'coaching' ? 'primary' : 'default'"
          @click="activePosts = 'coaching'"
          class="tab-button"
        >
          Coaching
        </BaseButtonAction>
    ...
    <div class="flex justify-end mb-4">
      <div class="mt-2 flex flex-wrap gap-2">
        ...
        >
          Pending
          <BaseButtonClose
            class="!text-muted-500 !h-4 !w-4 p-[1px] ms-1"
            rounded="none"
          />
        </span>
        <span
    ...
    <div class="grid grid-cols-12 gap-6">
      ...
      <div class="col-span-12 md:col-span-3">
        ...
        <div class="rounded-xl relative">
          ...
          ></div>
          <div
            class="relative px-6 py-8 flex flex-col-reverse gap-6 md:flex-row justify-between"
          >
            <div class="absolute top-6 right-6">
              ...
              <p class="text-white text-base text-center">Tasks</p>
            </div>
            <div class="pt-32">
              <div class="flex gap-4 items-center mb-2">
                <Icon name="ph:flag-thin" class="text-white w-6 h-6" />
                <h4 class="text-white font-medium text-lg">All Gaming</h4>
              </div>
              <p class="text-sm text-white">
        ...
        <div class="space-y-10 mt-6">
          ...
          <div class="relative">
            <!-- Title -->
            <div
              class="mb-4 p-2 rounded-md flex items-center gap-4 bg-white dark:bg-muted-700"
            >
            ...
            <div class="flex flex-col gap-4 ps-2">
              <div class="flex items-center justify-between">
                ...
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  28
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
          ...
          <div class="relative">
            ...
            <div class="flex flex-col gap-4 ps-2">
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Super Mario" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  28
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Fortnight" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  28
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="COD" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  28
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Carts" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  28
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Contra" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  28
                </BaseTag>
              </div>
          ...
          <div class="relative">
            ...
            <div class="flex flex-col gap-4 ps-2">
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Skill 1" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  2
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Skill 2" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  23
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Skill 3" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  12
                </BaseTag>
              </div>
          ...
          <div class="relative">
            ...
            <div class="flex flex-col gap-4 ps-2">
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Android" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  2
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Apple" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  23
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="PC/Laptop" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  12
                </BaseTag>
              </div>
              <div class="flex items-center justify-between">
                <BaseCheckbox value="all" label="Xbox" shape="rounded" />
                <BaseTag color="primary" shape="full" class="text-xs" size="sm">
                  12
                </BaseTag>
              </div>
            ...
            >
              ...
              >
                <BaseCard shape="curved" class="p-2 shadow-md pb-16">
                  <BaseCard
                    class="mb-2 flex justify-between gap-4 p-1 px-2 items-center"
                  >
                    <div>
                      <p class="text-xs text-primary-500">Puzzle game</p>
                    </div>

                    <div class="flex gap-1">
                      <Icon
                        name="material-symbols:android"
                        class="text-muted-400 block w-4 h-4"
                      />
                      <Icon
                  ...
                  <div class="mt-4">
                    <p class="text-xs text-muted-400">
                      Gaming Education / Core Skills Development
                    </p>
                  </div>
                  ...
                  <div class="mt-4">
                    <div class="flex gap-5 items-center">
                      ...
                      />
                      <span
                        class="text-muted-800 dark:text-muted-100 block text-xs"
                      >
                        50%
                      </span>
                    </div>
                  ...
                  >
                    <h4
                      class="text-primary-500 dark:text-muted-100 font-sans text-xs font-medium"
                    >
