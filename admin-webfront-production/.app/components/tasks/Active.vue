...
const { games, skills, segments, selectedGame, selectedSkill, selectedSegment } = defineProps([
  'games',
  'skills',
  'segments',
  'selectedGame',
...
const game = ref(selectedGame || [])
const skill = ref(selectedSkill || [])
const segment = ref(selectedSegment ? selectedSegment : '')
      ...
      <BaseCard class="ptablet:py-8 ptablet:px-4 mb-10 py-4 px-4">
        ...
        >
          ...
          <div class="ptablet:col-span-6 w-full flex-1 px-2 py-2 sm:w-auto relative">
            ...
            <BaseListbox v-model="segment" :items="segmentList" placeholder="Select Segment" />
          </div>
