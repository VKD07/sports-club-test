            ...
            <BaseCard shape="curved" class="p-4 shadow-md">
              ...
              <div class="flex items-center justify-between mt-4">
                ...
                <div class="flex gap-4 items-center">
                  ...
                  <div>
                    <BaseDropdown flavor="context" label="Dropdown" orientation="end" shape="smooth">
                      <BaseDropdownItem to="/tournaments/manage" title="Manage" text="Manage tournament" shape="smooth" />
                      <BaseDropdownItem title="Duplicate" text="Duplicate tournament" shape="smooth" />
                      <BaseDropdownItem title="Deactivate" text="Deactivate tournament" shape="smooth" />
                      <BaseDropdownItem title="Delete" text="Remove tournament" shape="smooth" />
                    </BaseDropdown>
                  </div>
                </div>
              </div>
