...
import type { DefaultProps, NinjaToasterBaseProps } from '@cssninja/nuxt-toaster'

// This type infer the props of TairoToaster component
type TairoToasterProps = Omit<InstanceType<typeof TairoToaster>['$props'], keyof DefaultProps>
...
export function useToaster() {
  ...
  function show(props: TairoToasterProps, options?: NinjaToasterBaseProps) {
    ...
    return $nt.showComponent('TairoToaster', {
      props: restProps,
      options: { duration, ...options }, // Pass duration to options
    })
  }
