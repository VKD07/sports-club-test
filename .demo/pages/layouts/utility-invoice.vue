  ...
  <div class="mx-auto max-w-3xl py-10">
    <div class="mb-4 flex items-center justify-between">
      ...
      <div class="flex items-center justify-end gap-3">
        ...
        <BaseButtonIcon size="sm" shape="full" data-nui-tooltip="Download as PDF">
          ...
          <div>
            ...
            >
              ...
              <div class="flex gap-12">
                <div class="text-muted-500 dark:text-muted-400 text-sm font-light">
                  <p class="text-muted-700 dark:text-muted-100 text-xs font-normal">
                    Invoice Number
                  </p>
                  <p>INV-48654</p>

                  <p class="text-muted-700 dark:text-muted-100 mt-2 text-xs font-normal">
                    Date of Issue
                  </p>
                  <p>03.19.2023</p>
                </div>
                <div class="text-muted-500 dark:text-muted-400 text-sm font-light">
                  <p class="text-muted-700 dark:text-muted-100 text-xs font-normal">Terms</p>
                  <p>30 Days</p>

                  <p class="text-muted-700 dark:text-muted-100 mt-2 text-xs font-normal">Due</p>
                  <p>04.19.2023</p>
                </div>
              </div>
            </div>
            ...
            >
              <div class="flex items-center gap-4">
                ...
                <div class="">
                  ...
                  <BaseParagraph size="xs" class="text-muted-400"> Software company </BaseParagraph>
                </div>
              </div>
              <div class="flex gap-12">
                <div class="text-muted-500 dark:text-muted-400 text-sm font-light">
                  <p class="text-muted-700 dark:text-muted-100 text-sm font-normal">Address</p>
                ...
                <table class="divide-muted-200 dark:divide-muted-700 min-w-full divide-y">
                  ...
                  <tbody class="font-sans">
                    ...
                    >
                      ...
                      <td class="hidden px-3 py-4 text-right text-sm sm:table-cell">
                      ...
                      <td class="text-muted-400 hidden px-3 py-4 text-right text-sm sm:table-cell">
                        ${{ item.rate }}
                      </td>
                      <td
              ...
              <div class="border-muted-200 dark:border-muted-700 border-t pt-8">
                <div class="text-muted-400">
                  <BaseParagraph size="xs">
                    Payment terms are 14 days. Please be aware that according to the Late Payment of
                    company Debts Acts, freelancers are entitled to claim a 00.00 late fee upon
                    non-payment of debts after this time, at which point a new invoice will be
                    submitted with the addition of this fee. If payment of the revised invoice is
                    not received within a further 14 days, additional interest will be charged to
                    the overdue account and a statutory rate of 8% plus Bank base of 0.5%, totalling
